...
- DEM: ["COPERNICUS_30"] -> derived slope, aspect (float)
- Latitude and Longitude rasters @30m (float)

- Thuenen agricultural mask for Germany for available years (https://eodata.thuenen.de/collections/crop-type-map-latest ??)


## Preprocessing

- Sentinel-3 compositing
- Sentinel-3 sharpening (maybe daily incidence calculation)
- maybe biophysical parameter derivation
- Sentinel-2, DEM (+derivates), Lat, Long, Thuenen all coregistered (warped)
- Sentinel-3 will be matching after sharpening
