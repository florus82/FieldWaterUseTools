...
import FieldWaterUseTools.FuncBox.other_repos.pyDMS.pyDMS.pyDMSUtils as utils
    ...
    def trainSharpener(self):
        ...
        for highResFile, lowResFile in zip(self.highResFiles, self.lowResFiles):
            ...
            if self.useQuality_LR:
                ...
                qualityPix = np.isin(subsetQualityMask.ravel(), # ind1
...
class NeuralNetworkSharpener(DecisionTreeSharpener):
    ...
    def _doFit(self, goodData_LR, goodData_HR, weights, local):
